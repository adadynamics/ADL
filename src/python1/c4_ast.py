...
class FnDecl:
    def __init__(self):
        ...
        self.retparam = None
        self.block = None
        self.alloc = AllocType.ALLOC_NO_ACCESS
...
class VarDecl:
    def __init__(self):
        ...
        self.previous_alloc = AllocType.ALLOC_NONE
        self.restore = AllocType.ALLOC_NO_ACCESS
...
class AllocType(Enum):
    ALLOC_OWNER = 0
    ALLOC_RETURNED = 1
    ALLOC_MUTABLE_BORROW = 2
    ALLOC_IMMUTABLE_BORROW = 3
    ALLOC_NO_ACCESS = 4
    ALLOC_NONE = 5

class Symbol:
    def __init__(self,name,type,kind,val = None,alloc = AllocType.ALLOC_NONE):
        self.name = name
        self.type = type
        self.kind = kind
