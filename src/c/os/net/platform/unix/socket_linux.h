#ifndef ADL_SRC_OS_NET_PLATFORM_UNIX_SOCKET_LINUX_H
#define ADL_SRC_OS_NET_PLATFORM_UNIX_SOCKET_LINUX_H
...
typedef struct ADL_SOCKET_LINUX
{
...
void ADL_SOCKET_LINUX_Init(ADL_SOCKET_LINUX *class);

void ADL_SOCKET_LINUX_Fini(ADL_SOCKET_LINUX *class);
